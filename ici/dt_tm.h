...
#define __TYPE_DEFINITION_DATE_TIME_BR_TO_BS__ 1
...
typedef struct tag_DateTimeHldDsc
{
	union 
	{
	    	...
	    	long   lArDateTime [SIZE_DATE_TIME_INFO>>2];
#endif 			
...
#define SIZE_DATE_TIME  (sizeof( holderDateTime.UNDateTime.sBrDateTimeInfoWrp ))
#endif
