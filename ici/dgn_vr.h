...
#define __TYPE_DEFINITION_DIAGN_BR 1
									  
#ifndef __TYPE_DEFINITION_DIAGN_BR
#define SIZE_DIAGN 8
#else
...
typedef struct tag_DiagnHldDsc
{
	union 
	{
	    	...
	    	long   lArSDFE  [SIZE_DIAGN>>2];
#endif 			
#ifdef __TYPE_DEFINITION_DIAGN_BR
			//Obj xxx_FCoil;
...
extern int AppReqTransmitDiagnBrBs;
extern int AppReqTransmitDiagnBrBM;
extern int AppReqReceiveDiagnBmBr ;
extern int AppReqReceiveDiagnBsBr ;

extern DiadnHldDsc holderDiagnBrBs;
extern DiadnHldDsc holderDiagnBrBm;
...
#define __TYPE_DEFINITION_VER_INFO_BR 1
									  
#ifndef __TYPE_DEFINITION_VER_INFO_BR
...
typedef struct tag_TotVerInfoHldDsc
{
	union 
	{
	    	...
	    	long   lArVerI [SIZE_VER_INFO>>2];
#endif 			
#ifdef __TYPE_DEFINITION_VER_INFO_BR
			//Obj xxx_FCoil;
...
extern int AppReqReceiveTotVerInfo ;

extern TotVerInfoHldDsc holderTotVerInfo;
extern TotVerInfoHldDsc holderTotVerInfo;
