/***********************************************************************
 * $Id: lpc32xx_dma_driver.c 30870 2009-07-05 10:16:16Z anderslu $
 *
...
#include "../include/lpc32xx_dma_driver.h"
...
STATUS Dma_init(void)
{
  ...
  if (dmadrv_dat.init == FALSE)
  {
    ...
    dmadrv_dat.pdma->raw_tc_stat = 0xFF;//--Is Error?
	dmadrv_dat.pdma->int_err_clear = 0xFF;
