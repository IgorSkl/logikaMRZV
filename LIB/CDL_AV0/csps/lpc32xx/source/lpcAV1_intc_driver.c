/***********************************************************************
 * $Id: lpc32xx_intc_driver.c 30870 2009-07-05 10:16:16Z anderslu $
 *
...
#include "../../../lpc/include/lpc_arm_arch.h"
#include "../../../lpc/include/lpc_arm922t_cp15_driver.h"
...
#define lpc32xx_reset_vector  __vector   //;
#define vec_reset_handler     __vector   //;
#define vec_undefined_handler __vector   //;
#define vec_swi_handler       __vector   //;
#define vec_prefetch_handler  __vector   //;
#define vec_abort_handler     __vector   //;
#define vec_irq_handler       irq_handler//;
#define vec_fiq_handler       fiq_handler//;
...
extern PFV irq_func_ptrs[IRQ_END_OF_INTERRUPTS];

/* Pointer to logical interrupt vector area (writable) */
extern UNS_32 *vecarea;
...
static long IntFuncUseCounter = 0; 
/***********************************************************************
 *
 * Function: int_enable
 *
...
void Int_enable1(INTERRUPT_SOURCE_T source)
{
disable_irq();
MIC->er|=  _BIT(source);
enable_irq();
...
void Int_disable1(INTERRUPT_SOURCE_T source)
{
disable_irq();
MIC->er &= ~ _BIT(source);
enable_irq();
...
void Int_disableGen(INTERRUPT_SOURCE_T source)
{
disable_irq_fiq();
MIC->er &= ~ _BIT(source);
enable_irq_fiq();
}
void Int_enableGen(INTERRUPT_SOURCE_T source)
{
disable_irq_fiq();
MIC->er|=  _BIT(source);
//enable_irq();
