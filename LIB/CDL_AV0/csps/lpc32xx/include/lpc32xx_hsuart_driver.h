/***********************************************************************
 * $Id: lpc32xx_hsuart_driver.h 30870 2009-07-05 10:16:16Z anderslu $
 *
...
#ifndef LPC32XX_HSUART_DRIVER_AV1_H
#define LPC32XX_HSUART_DRIVER_AV1_H

#include "./lpc32xx_hsuart.h"
#include "../../../lpc/include/lpc_params.h"
...
typedef struct
{
  ...
  PFV rxerrcb;
  PFV eofcb; /* Pointer to End of Frame*/
} HSUART_CBS_T;
...
INT_32  hs_uart_recover(INT_32 devid);
#ifdef __cplusplus
}
#endif
