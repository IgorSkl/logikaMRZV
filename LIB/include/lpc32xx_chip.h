/***********************************************************************
 * $Id: lpc32xx_chip.h 30870 2009-07-05 10:16:16Z anderslu $
 *
...
// ARM_CLK 208MHz
#define CORE_CLK      (208000000UL)     //(OSC*16)
// HCLK 104MHz
#define AHB_CLK       (104000000UL)     //(CORE_CLK/2)
// PER_CLK 13MHz
#define PER_CLK       (13000000UL)      //(CORE_CLK/16)
