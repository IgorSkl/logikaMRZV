...
//установки ICI TZNP
 int numBlok=0;
//---------------TZNP1--------------------
  int tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGUST_TZNP1to5_3I0);//уставка TZNP1 3I0
//    lMtz1 = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthPickup.ov_range_3Io_Tznp;

   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGUST_TZNP1to5_3U0);//уставка TZNP1 3U0 
//    lMtz1 = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthPickup.ov_range_3Uo_Tznp;

   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGVID_TZNP1to5);//уставка выдержки TZNP1
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthStageParam.time_Tznp;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGVID_TZNP1to5_3I0);//уставка выдержки 3I0 TZNP1
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthStageParam.Tznp_time_stage_3I0;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGVID_TZNP1to5_3U0);//уставка выдержки 3U0 TZNP1
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthStageParam.Tznp_time_stage_3U0;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGVUSK_TZNP1to5);//уставка ввод ускор TZNP1
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthStageParam.Tznp_Tau_AcltImp;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGUSK_TZNP1to5);//уставка ускор TZNP1 BB
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthStageParam.Tznp_time_stage_Aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGUSK_TZNP1to5_OU);//уставка ускор TZNP1 OU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthStageParam.Tznp_T_op_aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGUSK_TZNP1to5_TU);//уставка ускор TZNP1 TU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthStageParam.Tznp_T_tele_aclt;



   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGUSK_TZNP1to5_3I0);//уставка ускор TZNP1 3I0 BB
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthStageParam.Tznp3I0_time_stage_Aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGUSK_TZNP1to5_3I0_OU);//уставка ускор TZNP1 3I0 OU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthStageParam.Tznp3I0_T_op_aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGUSK_TZNP1to5_3I0_TU);//уставка ускор TZNP1 3I0 TU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage1DrErthStageParam.Tznp3I0_T_tele_aclt;


//---------------TZNP2--------------------
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGUST_TZNP1to5_3I0);//уставка TZNP2 3I0 
//    lMtz1 = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthPickup.ov_range_3Io_Tznp;
    
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGUST_TZNP1to5_3U0);//уставка TZNP2 3U0 
//    lMtz1 = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthPickup.ov_range_3Uo_Tznp;
    

   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGVID_TZNP1to5);//уставка выдержки TZNP2
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthStageParam.time_Tznp;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGVID_TZNP1to5_3I0);//уставка выдержки 3I0 TZNP2
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthStageParam.Tznp_time_stage_3I0;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGVID_TZNP1to5_3U0);//уставка выдержки 3U0 TZNP2
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthStageParam.Tznp_time_stage_3U0;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGVUSK_TZNP1to5);//уставка ввод ускор TZNP2
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthStageParam.Tznp_Tau_AcltImp;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGUSK_TZNP1to5);//уставка ускор TZNP2 BB
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthStageParam.Tznp_time_stage_Aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGUSK_TZNP1to5_OU);//уставка ускор TZNP2 OU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthStageParam.Tznp_T_op_aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGUSK_TZNP1to5_TU);//уставка ускор TZNP2 TU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthStageParam.Tznp_T_tele_aclt;



   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGUSK_TZNP1to5_3I0);//уставка ускор TZNP2 3I0 BB
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthStageParam.Tznp3I0_time_stage_Aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGUSK_TZNP1to5_3I0_OU);//уставка ускор TZNP2 3I0 OU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthStageParam.Tznp3I0_T_op_aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGUSK_TZNP1to5_3I0_TU);//уставка ускор TZNP2 3I0 TU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage2DrErthStageParam.Tznp3I0_T_tele_aclt;


//---------------TZNP3--------------------
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGUST_TZNP1to5_3I0);//уставка TZNP3 3I0 
//    lMtz1 = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthPickup.ov_range_3Io_Tznp;
    
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGUST_TZNP1to5_3U0);//уставка TZNP3 3U0 
//    lMtz1 = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthPickup.ov_range_3Uo_Tznp;
    

   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGVID_TZNP1to5);//уставка выдержки TZNP3
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthStageParam.time_Tznp;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGVID_TZNP1to5_3I0);//уставка выдержки 3I0 TZNP3
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthStageParam.Tznp_time_stage_3I0;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGVID_TZNP1to5_3U0);//уставка выдержки 3U0 TZNP3
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthStageParam.Tznp_time_stage_3U0;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGVUSK_TZNP1to5);//уставка ввод ускор TZNP3
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthStageParam.Tznp_Tau_AcltImp;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGUSK_TZNP1to5);//уставка ускор TZNP3 BB
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthStageParam.Tznp_time_stage_Aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGUSK_TZNP1to5_OU);//уставка ускор TZNP3 OU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthStageParam.Tznp_T_op_aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGUSK_TZNP1to5_TU);//уставка ускор TZNP3 TU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthStageParam.Tznp_T_tele_aclt;



   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGUSK_TZNP1to5_3I0);//уставка ускор TZNP3 3I0 BB
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthStageParam.Tznp3I0_time_stage_Aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGUSK_TZNP1to5_3I0_OU);//уставка ускор TZNP3 3I0 OU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthStageParam.Tznp3I0_T_op_aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGUSK_TZNP1to5_3I0_TU);//уставка ускор TZNP3 3I0 TU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage3DrErthStageParam.Tznp3I0_T_tele_aclt;

  
//---------------TZNP4--------------------
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGUST_TZNP1to5_3I0);//уставка TZNP4 3I0 
//    lMtz1 = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthPickup.ov_range_3Io_Tznp;
    
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGUST_TZNP1to5_3U0);//уставка TZNP4 3U0 
//    lMtz1 = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthPickup.ov_range_3Uo_Tznp;
    

   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGVID_TZNP1to5);//уставка выдержки TZNP4
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthStageParam.time_Tznp;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGVID_TZNP1to5_3I0);//уставка выдержки 3I0 TZNP4
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthStageParam.Tznp_time_stage_3I0;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGVID_TZNP1to5_3U0);//уставка выдержки 3U0 TZNP4
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthStageParam.Tznp_time_stage_3U0;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGVUSK_TZNP1to5);//уставка ввод ускор TZNP4
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthStageParam.Tznp_Tau_AcltImp;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGUSK_TZNP1to5);//уставка ускор TZNP4 BB
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthStageParam.Tznp_time_stage_Aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGUSK_TZNP1to5_OU);//уставка ускор TZNP4 OU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthStageParam.Tznp_T_op_aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGUSK_TZNP1to5_TU);//уставка ускор TZNP4 TU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthStageParam.Tznp_T_tele_aclt;



   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGUSK_TZNP1to5_3I0);//уставка ускор TZNP4 3I0 BB
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthStageParam.Tznp3I0_time_stage_Aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGUSK_TZNP1to5_3I0_OU);//уставка ускор TZNP4 3I0 OU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthStageParam.Tznp3I0_T_op_aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGUSK_TZNP1to5_3I0_TU);//уставка ускор TZNP4 3I0 TU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage4DrErthStageParam.Tznp3I0_T_tele_aclt;


//---------------TZNP5--------------------
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGUST_TZNP1to5_3I0);//уставка TZNP5 3I0 
//    lMtz1 = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage5DrErthPickup.ov_range_3Io_Tznp;
    
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGUST_TZNP1to5_3U0);//уставка TZNP5 3U0 
//    lMtz1 = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage5DrErthPickup.ov_range_3Uo_Tznp;
    

   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGVID_TZNP1to5);//уставка выдержки TZNP5
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage5DrErthStageParam.time_Tznp;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGVID_TZNP1to5_3I0);//уставка выдержки 3I0 TZNP5
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage5DrErthStageParam.Tznp_time_stage_3I0;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGVID_TZNP1to5_3U0);//уставка выдержки 3U0 TZNP5
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage5DrErthStageParam.Tznp_time_stage_3U0;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGVUSK_TZNP1to5);//уставка ввод ускор TZNP5
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage5DrErthStageParam.Tznp_Tau_AcltImp;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGUSK_TZNP1to5);//уставка ускор TZNP5 BB
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage5DrErthStageParam.Tznp_time_stage_Aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGUSK_TZNP1to5_OU);//уставка ускор TZNP5 OU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage5DrErthStageParam.Tznp_T_op_aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGUSK_TZNP1to5_TU);//уставка ускор TZNP5 TU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage5DrErthStageParam.Tznp_T_tele_aclt;



   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGUSK_TZNP1to5_3I0);//уставка ускор TZNP5 3I0 BB
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage5DrErthStageParam.Tznp3I0_time_stage_Aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGUSK_TZNP1to5_3I0_OU);//уставка ускор TZNP5 3I0 OU
//    lMtz1Tmr = brCfgTbl.arPckpStpmStngStore[numBlok].ownrStage5DrErthStageParam.Tznp3I0_T_op_aclt;


   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGUSK_TZNP1to5_3I0_TU);//уставка ускор TZNP5 3I0 TU
...
//---------------TZNP1--------------------
/*
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  1, MNGUPR_TZNP1to5);//управление TZNP1
//  int uprTZNP1=0;
...
//---------------TZNP2--------------------
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  2, MNGUPR_TZNP1to5);//управление TZNP2
//  int uprTZNP2=0;
...
//---------------TZNP3--------------------
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  3, MNGUPR_TZNP1to5);//управление TZNP3
  //int uprTZNP3=0;
...
//---------------TZNP4--------------------
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  4, MNGUPR_TZNP1to5);//управление TZNP4
  //int uprTZNP4=0;
...
//---------------TZNP5--------------------
   tmpUst = GetUstFromImageClon(numBlok, TZNP_COMP1,  5, MNGUPR_TZNP1to5);//управление TZNP5
//  int uprTZNP5=0;
