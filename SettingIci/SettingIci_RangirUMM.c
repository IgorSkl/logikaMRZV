...
//Пуск Umin1
 if(isActivCmdDV(START_UMIN1_DI_IEPRF_ONB, numDV))//проверка активности команды на ДВ
      SetCmdToUVV(UMM_COMP1,  1, IOCMDPUSK1_UMM, nDV);//отранж 
//Пуск Umin2
 if(isActivCmdDV(START_UMIN2_DI_IEPRF_ONB, numDV))//проверка активности команды на ДВ
      SetCmdToUVV(UMM_COMP1,  1, IOCMDPUSK2_UMM, nDV);//отранж 
...
//Пуск Umin1
 if(isActivCmdDV(START_UMIN1_DI_OEPRF_ONB, numRele))//проверка активности команды на ДВ
      SetCmdToUVV(UMM_COMP1,  1, IOCMDPUSK1_UMM, nRele);//отранж 
//Пуск Umin2
 if(isActivCmdDV(START_UMIN2_DI_OEPRF_ONB, numRele))//проверка активности команды на ДВ
      SetCmdToUVV(UMM_COMP1,  1, IOCMDPUSK2_UMM, nRele);//отранж 
...
//Пуск Umin1
 if(isActivCmdDV(START_UMIN1_DI_OEPRF_ONB, numLed))//проверка активности команды на ДВ
      SetCmdToUVV(UMM_COMP1,  1, IOCMDPUSK1_UMM, nLed);//отранж 
//Пуск Umin2
 if(isActivCmdDV(START_UMIN2_DI_OEPRF_ONB, numLed))//проверка активности команды на ДВ
      SetCmdToUVV(UMM_COMP1,  1, IOCMDPUSK2_UMM, nLed);//отранж 
